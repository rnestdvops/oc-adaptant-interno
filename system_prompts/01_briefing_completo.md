...
> Este es el contexto base que se inyecta al modelo para usuarios autenticados como **socios** o **asesores**. Es la condensación operativa del briefing maestro `Commons_Briefing_BHP_Adaptant_jun2026.docx`.
>
...
| Cuentas MP | MP1 (principal) + MP2 = BHP Global (canal alternativo) |
...
| BHP Global (MP2) | 7 transf. internas | 14.210.000 | Segunda cuenta MP — extractos pendientes |
...
| Línea | Foco |
|---|---|
| A · Reducción controlada BHP | Detener sangría de obligaciones nuevas. Baja como empleados de Ernesto y Franco (solo directores). Definir situación de Carolina. DDJJ formales al día. Manejo defensivo de cuentas. |
| B · Constitución Adaptant | Sin urgencia hoy (sin clientes locales) pero en marcha. Estatuto listo, checklist preparado. Perfil bajo hasta primer cliente. |
...
- Decisiones sobre Carolina. Adhesión a moratoria. Cierre formal de cualquier sociedad.
